      ...
      {!loading && !data?.data?.coins ? (
          ...
          <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className="mx-auto max-w-screen-sm text-center">
              ...
              <p className="mb-4 text-lg text-center font-light text-gray-500 dark:text-gray-400">
                Sorry, <span className="font-semibold text-blue-700">Cryptocurrencies</span> page is not working
              </p>
              <button
                onClick={() => navigate("/")}
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-4">
            {!loading && !searchError && filteredCoins.length > 0
