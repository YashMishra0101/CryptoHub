...
const Cryptocurrencies = ({ data, loading }) => {
  ...
  return (
    <div className="w-screen overflow-hidden bg-gray-200 p-6 mt-4">
      <h2 className="text-3xl font-bold text-center text-gray-900 mb-8 lg:hover:underline select-none">
    <span className="hidden sm:block">Explore the Top 50 Cryptocurrencies</span>
    <span className=" sm:hidden block text-[1.7rem] py-2 text-center bg-gray-900 text-green-100 p-[0.40rem] rounded-md font-serif">Top 50 Cryptocurrencies</span>
  </h2>
      ...
      {showAllCoins && (
        <span className="w-full block md:inline-block text-center md:text-right -mt-6 mb-3">
          <button
            ...
            className="text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2"
          >
            Show All Coins
          </button>
        </span>
      ...
      {/* Conditional rendering based on search error */}
        ...
        {searchError && (
          <div className="md:w-[35rem] md:h-[15rem] h-[16m] text-center block mx-auto relative md:bottom-[2rem] mb-56">
            <div className="md:w-[30rem] text-center bg-red-100 border border-red-400 rounded-md mx-auto">
              <p className="text-red-500 text-lg md:text-xl font-mono">
