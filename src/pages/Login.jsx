...
const Login = () => {
  ...
  return (
    <div>
      <div className="bg-gray-50 dark:bg-gray-900 min-h-[40rem] overflow-hidden">
        <div className="flex flex-col items-center justify-center px-6 py-7 mx-auto md:h-screen lg:py-0 relative">
